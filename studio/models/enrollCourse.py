...
class EnrollCourse(TimeStampedUUIDModel):
    ...
    course_progress = models.FloatField(default=0,validators=[MinValueValidator(0),MaxValueValidator(100)],blank=True,null=True)
    is_enrolled = models.BooleanField(default=False,blank=True)
    is_CourseStarted = models.BooleanField(default=False,blank=True)
